...
df_nascidos_aux <- dados_preliminares_2023 |>
...
df_nascidos_2023 <- full_join(df_nascidos_2021, df_nascidos_aux) |>
  arrange(UF, Municipio)

# Exportando os dados 
write.table(df_nascidos_2023, 'R/databases/Nascimentos_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Nascidos vivos prematuros -----------------------------------------------
df_prematuros_2021 <- read.csv2("R/databases/Prematuridade_muni2021.csv")

df_prematuros_aux <- dados_preliminares_2023 |>
...
df_prematuros_2023 <- full_join(df_prematuros_2021, df_prematuros_aux)

# Exportando os dados (Nascimentos_muni = UF, Município, Ano e Nascimentos)
write.table(df_prematuros_2023, 'R/databases/Prematuridade_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Tipo de gestação --------------------------------------------------------
df_tipo_gravidez_2021 <- read.csv2("R/databases/Tipo_gravidez_muni2021.csv")

df_tipo_gravidez_aux <- dados_preliminares_2023 |>
...
df_tipo_gravidez_2023 <- full_join(df_tipo_gravidez_2021, df_tipo_gravidez_aux)

# Exportando os dados 
write.table(df_tipo_gravidez_2023, 'R/databases/Tipo_gravidez_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Tipo de parto -----------------------------------------------------------
df_tipo_parto_2021 <- read.csv2("R/databases/Tipo_parto_muni2021.csv")

df_tipo_parto_aux <- dados_preliminares_2023 |>
...
df_tipo_parto_2023 <- full_join(df_tipo_parto_2021, df_tipo_parto_aux)

# Exportando os dados 
write.table(df_tipo_parto_2023, 'R/databases/Tipo_parto_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Número de consultas de pré-natal ----------------------------------------
df_consultas_2021 <- read.csv2("R/databases/Consultas_PreNatal_muni2021.csv")

df_consultas_aux <- dados_preliminares_2023 |>
...
df_consultas_2023 <- full_join(df_consultas_2021, df_consultas_aux)

# Exportando os dados 
write.table(df_consultas_2023, 'R/databases/Consultas_PreNatal_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Sexo fetal --------------------------------------------------------------
df_sexo_fetal_2021 <- read.csv2("R/databases/Sexo_fetal_muni2021.csv")

df_sexo_fetal_aux <- dados_preliminares_2023 |>
...
df_sexo_fetal_2023 <- full_join(df_sexo_fetal_2021, df_sexo_fetal_aux)

# Exportando os dados 
write.table(df_sexo_fetal_2023, 'R/databases/Sexo_fetal_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Apgar 1 -----------------------------------------------------------------
df_apgar1_2021 <- read.csv2("R/databases/Apgar1_muni2021.csv")

df_apgar1_aux <- dados_preliminares_2023 |>
...
df_apgar1_2023 <- full_join(df_apgar1_2021, df_apgar1_aux)

# Exportando os dados 
write.table(df_apgar1_2023, 'R/databases/Apgar1_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Apgar 5 -----------------------------------------------------------------
df_apgar5_2021 <- read.csv2("R/databases/Apgar5_muni2021.csv")

df_apgar5_aux <- dados_preliminares_2023 |>
...
df_apgar5_2023 <- full_join(df_apgar5_2021, df_apgar5_aux)

# Exportando os dados 
write.table(df_apgar5_2023, 'R/databases/Apgar5_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Anomalias ---------------------------------------------------------------
df_anomalias_2021 <- read.csv2("R/databases/Anomalias_muni2021.csv")

df_anomalias_aux <- dados_preliminares_2023 |>
...
df_anomalias_2023 <- full_join(df_anomalias_2021, df_anomalias_aux)

# Exportando os dados 
write.table(df_anomalias_2023, 'R/databases/Anomalias_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Peso fetal menor que 2500g ----------------------------------------------
df_peso_fetal_2021 <- read.csv2("R/databases/Peso_menor_2500_muni2021.csv")

df_peso_fetal_aux <- dados_preliminares_2023 |>
...
df_peso_fetal_2023 <- full_join(df_peso_fetal_2021, df_peso_fetal_aux)

# Exportando os dados 
write.table(df_peso_fetal_2023, 'R/databases/Peso_menor_2500_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Raça/cor da mãe ---------------------------------------------------------
df_racamae_2021 <- read.csv2("R/databases/Raca_mae_muni2021.csv")

df_racamae_aux <- dados_preliminares_2023 |>
...
df_racamae_2023 <- full_join(df_racamae_2021, df_racamae_aux)

# Exportando os dados 
write.table(df_racamae_2023, 'R/databases/Raca_mae_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Robson ------------------------------------------------------------------
df_robson_2021 <- read.csv2("R/databases/Robson_muni2021.csv")

df_robson_aux <- dados_preliminares_2023 |>
...
df_robson_2023 <- full_join(df_robson_2021, df_robson_aux)

# Exportando os dados 
write.table(df_robson_2023, 'R/databases/Robson_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Parto prematuro ---------------------------------------------------------
df_prematuro_pcdas_2021 <- read.csv2("R/databases/Prematuro_PCDAS_muni2021.csv")

df_prematuro_pcdas_aux <- dados_preliminares_2023 |>
  select(res_SIGLA_UF, res_MUNNOMEX, CODMUNRES, ano_nasc, GESTACAO) |>
  mutate(nascidos = 1) |>
  group_by(res_SIGLA_UF, res_MUNNOMEX, CODMUNRES, ano_nasc, GESTACAO) |>
  summarise(nascidos = sum(nascidos)) |>
...
df_prematuro_pcdas_2023 <- full_join(df_prematuro_pcdas_2021, df_prematuro_pcdas_aux)

# Exportando os dados 
write.table(df_prematuro_pcdas_2023, 'R/databases/Prematuro_PCDAS_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Cesárea eletiva ---------------------------------------------------------
df_ces_2021 <- read.csv2("R/databases/Cesaria_antes_do_parto_muni2021.csv")

df_ces_aux <- dados_preliminares_2023 |>
...
df_ces_2023 <- full_join(df_ces_2021, df_ces_aux)

# Exportando os dados
write.table(df_ces_2023, 'R/databases/Cesaria_antes_do_parto_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Partos induzidos --------------------------------------------------------
df_parto_induzido_2021 <- read.csv2("R/databases/Parto_induzido_muni2021.csv")

df_parto_induzido_aux <- dados_preliminares_2023 |>
...
df_parto_induzido_2023 <- full_join(df_parto_induzido_2021, df_parto_induzido_aux)

# Exportando os dados
write.table(df_parto_induzido_2023, 'R/databases/Parto_induzido_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Prematuridade consultas -------------------------------------------------
df_prematuridade_consultas_2021 <- read.csv2("R/databases/Prematuridade_consultas_muni2021.csv")

df_prematuridade_consultas_aux <- dados_preliminares_2023 |>
...
df_prematuridade_consultas_2023 <- full_join(df_prematuridade_consultas_2021, df_prematuridade_consultas_aux)

# Exportando os dados 
write.table(df_prematuridade_consultas_2023, 'R/databases/Prematuridade_consultas_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)


# Prematuros, cesáreas e Robson -------------------------------------------
df_robson_cesar_2021 <- read.csv2("R/databases/Robson_cesar_muni2021.csv")

df_robson_cesar_aux <- dados_preliminares_2023 |>
...
df_robson_cesar_2023 <- full_join(df_robson_cesar_2021, df_robson_cesar_aux)

# Exportando os dados (Nascimentos_muni = UF, Município, Ano e Nascimentos)
write.table(df_robson_cesar_2023, 'R/databases/Robson_cesar_muni2023.csv', sep = ";", dec = ".", row.names = FALSE)
