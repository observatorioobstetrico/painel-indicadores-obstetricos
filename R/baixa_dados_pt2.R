...
# Baixando os dados consolidados de 2023 e 2024 do SINASC ------------
...
## Lendo os dados consolidados e excluindo os arquivos baixados
...
rm(dados_preliminares_2023_aux1, dados_preliminares_2024_aux1)

## Juntando as bases consolidadas de 2023 e 2024
...
### Exportando os dados 
write.table(df_nascidos_completo, 'R/databases/Nascimentos_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
write.table(df_prematuros_completo, 'R/databases/Prematuridade_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_tipo_gravidez_completo, 'R/databases/Tipo_gravidez_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_tipo_parto_completo, 'R/databases/Tipo_parto_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_consultas_completo, 'R/databases/Consultas_PreNatal_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_sexo_fetal_completo, 'R/databases/Sexo_fetal_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_apgar1_completo, 'R/databases/Apgar1_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_apgar5_completo, 'R/databases/Apgar5_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_anomalias_completo, 'R/databases/Anomalias_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_peso_fetal_completo, 'R/databases/Peso_menor_2500_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_racamae_completo, 'R/databases/Raca_mae_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_robson_completo, 'R/databases/Robson_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_prematuro_pcdas_completo, 'R/databases/Prematuro_PCDAS_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados
write.table(df_ces_completo, 'R/databases/Cesaria_antes_do_parto_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados
write.table(df_parto_induzido_completo, 'R/databases/Parto_induzido_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados 
write.table(df_prematuridade_consultas_completo, 'R/databases/Prematuridade_consultas_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
...
### Exportando os dados (Nascimentos_muni = UF, Município, Ano e Nascimentos)
write.table(df_robson_cesar_completo, 'R/databases/Robson_cesar_muni_consolidados2.csv', sep = ";", dec = ".", row.names = FALSE)
