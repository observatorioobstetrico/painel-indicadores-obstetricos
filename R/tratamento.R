...
# Tratamento dos dados até o ano de 2025 ----
...
crunch::write.csv.gz(dados_sinasc_final, file = "dados_oobr_indicadores_obstetricos_sinasc_1996_2025.csv.gz")
...
crunch::write.csv.gz(dados_final, "dados_oobr_indicadores_obstetricos_prematuridade_consultas_1996_2025.csv.gz")
...
crunch::write.csv.gz(dados_robson_cesarea, file = "dados_oobr_indicadores_obstetricos_robson_cesareas_1996_2025.csv.gz")
