...
# Baixando os dados preliminares de 2025 do SINASC ------------
...
rm(dados_preliminares_2025_aux1)

## Juntando as bases preliminares
dados_preliminares_aux <- dados_preliminares_2025_aux2
...
df_nascidos_consolidados <- read.csv2("R/databases/Nascimentos_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_nascidos_completo, 'R/databases/Nascimentos_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)

## Nascidos vivos prematuros -----------------------------------------------
df_prematuros_consolidados <- read.csv2("R/databases/Prematuridade_muni_consolidados2.csv")
...
write.table(df_prematuros_completo, 'R/databases/Prematuridade_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)

## Tipo de gestação --------------------------------------------------------
df_tipo_gravidez_consolidados <- read.csv2("R/databases/Tipo_gravidez_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_tipo_gravidez_completo, 'R/databases/Tipo_gravidez_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)

## Tipo de parto -----------------------------------------------------------
df_tipo_parto_consolidados <- read.csv2("R/databases/Tipo_parto_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_tipo_parto_completo, 'R/databases/Tipo_parto_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)

## Número de consultas de pré-natal ----------------------------------------
df_consultas_consolidados <- read.csv2("R/databases/Consultas_PreNatal_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_consultas_completo, 'R/databases/Consultas_PreNatal_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)

## Sexo fetal --------------------------------------------------------------
df_sexo_fetal_consolidados <- read.csv2("R/databases/Sexo_fetal_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_sexo_fetal_completo, 'R/databases/Sexo_fetal_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)

## Apgar 1 -----------------------------------------------------------------
df_apgar1_consolidados <- read.csv2("R/databases/Apgar1_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_apgar1_completo, 'R/databases/Apgar1_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)

## Apgar 5 -----------------------------------------------------------------
df_apgar5_consolidados <- read.csv2("R/databases/Apgar5_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_apgar5_completo, 'R/databases/Apgar5_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)

## Anomalias ---------------------------------------------------------------
df_anomalias_consolidados <- read.csv2("R/databases/Anomalias_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_anomalias_completo, 'R/databases/Anomalias_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)


## Peso fetal menor que 2500g ----------------------------------------------
df_peso_fetal_consolidados <- read.csv2("R/databases/Peso_menor_2500_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_peso_fetal_completo, 'R/databases/Peso_menor_2500_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)


## Raça/cor da mãe ---------------------------------------------------------
df_racamae_consolidados <- read.csv2("R/databases/Raca_mae_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_racamae_completo, 'R/databases/Raca_mae_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)


## Robson ------------------------------------------------------------------
df_robson_consolidados <- read.csv2("R/databases/Robson_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_robson_completo, 'R/databases/Robson_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)


## Parto prematuro ---------------------------------------------------------
df_prematuro_pcdas_consolidados <- read.csv2("R/databases/Prematuro_PCDAS_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_prematuro_pcdas_completo, 'R/databases/Prematuro_PCDAS_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)


## Cesárea eletiva ---------------------------------------------------------
df_ces_consolidados <- read.csv2("R/databases/Cesaria_antes_do_parto_muni_consolidados2.csv")
...
### Exportando os dados
write.table(df_ces_completo, 'R/databases/Cesaria_antes_do_parto_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)


## Partos induzidos --------------------------------------------------------
df_parto_induzido_consolidados <- read.csv2("R/databases/Parto_induzido_muni_consolidados2.csv")
...
### Exportando os dados
write.table(df_parto_induzido_completo, 'R/databases/Parto_induzido_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)


## Prematuridade consultas -------------------------------------------------
df_prematuridade_consultas_consolidados <- read.csv2("R/databases/Prematuridade_consultas_muni_consolidados2.csv")
...
### Exportando os dados 
write.table(df_prematuridade_consultas_completo, 'R/databases/Prematuridade_consultas_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)


## Prematuros, cesáreas e Robson -------------------------------------------
df_robson_cesar_consolidados <- read.csv2("R/databases/Robson_cesar_muni_consolidados2.csv")
...
### Exportando os dados (Nascimentos_muni = UF, Município, Ano e Nascimentos)
write.table(df_robson_cesar_completo, 'R/databases/Robson_cesar_muni_completo.csv', sep = ";", dec = ".", row.names = FALSE)