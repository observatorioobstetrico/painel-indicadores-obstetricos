...
crunch::write.csv.gz(dados_sinasc2021, file = "./databases/dados_sinasc.csv.gz")
...
crunch::write.csv.gz(dados_final, "./databases/prematuridade_consultas_muni.csv.gz")
...
crunch::write.csv.gz(dados_robson, file = "./databases/robson_muni.csv.gz")
...
crunch::write.csv.gz(dados_robson_cesarea, file = "./databases/robson_cesar_muni.csv.gz")
